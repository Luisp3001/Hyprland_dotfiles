    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                color: rootWidget.walColors.colors.color1
        ...
        RowLayout {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    height: 30
                    radius: 8
                    color: actionMouse.containsMouse ? rootWidget.walColors.colors.color2 : "transparent"
                    border.color: actionMouse.containsMouse ? "transparent" : "#3d4150"
                    border.width: 1
                    ...
                    Text {
                        ...
                        color: actionMouse.containsMouse ? "#1c1e26" : rootWidget.walColors.special.foreground
                        font.family: "JetBrains Mono"
                        font.pixelSize: 11
