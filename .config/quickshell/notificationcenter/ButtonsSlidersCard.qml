...
Lib.Card {
  ...
  Lib.CommandPoll {
    ...
    parse: function(o) {
      ...
      return {
        vol: isFinite(n) ? n : 0,
        isHeadphones: port.toLowerCase().includes("headphone")
      }
    }
    onUpdated: if (!volS.pressed) volS.value = value.vol
  }
    ...
    Layout.fillWidth: true
      ...
      Lib.ExpressiveSlider {
        ...
        icon: {
            ...
            if (volPoll.value && volPoll.value.isHeadphones) return "vol_headphones.svg"
