...
Rectangle {
    ...
    property bool wouldBeActive: root.hasPlayer && (root.isPlaying || root.recentlyPaused)

    // Only show if a player exists and it is playing or recently paused, and not force hidden
    property bool active: !root.forceHidden && root.wouldBeActive
