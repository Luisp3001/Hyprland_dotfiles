...
Item {
    ...
    focus: true
    Shortcut { sequence: "Esc"; onActivated: root.closeRequested() }
    ...
    // -------- Colors / Fonts --------
    property color cBg:      root.theme ? root.theme.bgPanel : (isDarkMode ? "#6b3f443c" : "#97a382")
    property color cBgAlt:   root.theme ? root.theme.bgMain : (isDarkMode ? '#6b3f443c' : '#97a382')
    property color cCard:    root.theme ? root.theme.bgCard : (isDarkMode ? "#282c2d" : "#c1c3ae")
    property color cFg:      root.theme ? root.theme.textPrimary : (isDarkMode ? "#D3C6AA" : "#1e2326")
    property color cMuted:   root.theme ? root.theme.textSecondary : (isDarkMode ? "#859289" : '#4d6049')
    property color cBorder:  root.theme ? root.theme.border : (isDarkMode ? '#d4708154' : '#d4586a3c')
    property color cGreen:   root.theme ? root.theme.accent : (isDarkMode ? "#A7C080" : "#576830")
    property color cRed:     root.theme ? root.theme.accentRed : (isDarkMode ? "#E67E80" : '#b13c3a')
    property color cBlue:    root.theme ? root.theme.accentBlue : (isDarkMode ? '#A7C080' : '#5c7267')
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    width: 32; height: 32
                    radius: 16
                    color: backHover.containsMouse ? cBgAlt : "transparent"
                    Text {
