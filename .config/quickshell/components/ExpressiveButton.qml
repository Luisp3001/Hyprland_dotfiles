    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Image {
                    id: iconImg
                    source: root.icon ? (root.icon.startsWith("/") || root.icon.startsWith("file://") || root.icon.startsWith("qrc:/") || root.icon.startsWith("../") ? root.icon : Qt.resolvedUrl("../assets/icons/" + root.icon)) : ""
